 ...
 * $config['from'] = '%email%';
 */
$config['from'] = array('info@theflightking.com' => 'The Flight King');
 ...
 */
$config['subject'] = 'Hi. New email subscriber: %email%';
 ...
 */
$config['autoreplySubject'] = 'Thanks for subscribing!';
...
$email = new Quform_Element('subscribe-email', 'Subscribe Email');
